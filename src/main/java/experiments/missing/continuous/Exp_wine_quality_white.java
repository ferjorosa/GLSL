...
public class Exp_wine_quality_white extends MissingContinuousExperiment {

    public Exp_wine_quality_white(Set<MissingContinuousMethod> methods) {
        super(methods);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        for(double missingPercentage = 0.3; missingPercentage < 0.4; missingPercentage += 0.1) {
