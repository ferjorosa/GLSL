...
public class Exp_webkb_336 extends MissingDiscreteExperiment {

    public Exp_webkb_336(Set<MissingDiscreteMethod> methods) {
        super(methods);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        /* Run experiment */
        Exp_webkb_336 exp = new Exp_webkb_336(methods);
