...
public class Exp_census_india extends MissingMixedExperiment {

    public Exp_census_india(Set<MissingMixedMethod> methods) {
        super(methods);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        /* Run experiment */
        Exp_census_india exp = new Exp_census_india(methods);
