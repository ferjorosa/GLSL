...
public class Exp_thyroid extends MissingMixedExperiment {

    public Exp_thyroid(Set<MissingMixedMethod> methods) {
        super(methods);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        /* Run experiment */
        Exp_thyroid exp = new Exp_thyroid(methods);
        for(double missingPercentage = 0.2; missingPercentage < 0.3; missingPercentage += 0.1) {
    ...
    public void runExperiment(double missingPercentage,
        ...
        System.out.println("------------------------------------------------------------------");
        System.out.println("------------------------------------------------------------------");
        System.out.println("----------------------------- THYROID (missing) ----------------------------");
        System.out.println("------------------------------------------------------------------");
        System.out.println("------------------------------------------------------------------");

        System.out.println("MISSING PERCENTAGE: "+missingPercentage);

        String dataName = "thyroid";
