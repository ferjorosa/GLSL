...
public class Exp_planning_relax extends MissingMixedExperiment {

    public Exp_planning_relax(Set<MissingMixedMethod> methods) {
        super(methods);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        /* Run experiment */
        Exp_planning_relax exp = new Exp_planning_relax(methods);
