...
public class Exp_parkinsons extends MissingMixedExperiment {

    public Exp_parkinsons(Set<MissingMixedMethod> methods) {
        super(methods);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        /* Run experiment */
        Exp_parkinsons exp = new Exp_parkinsons(methods);
