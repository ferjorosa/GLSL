...
public class Exp_thoracic_surgery extends MissingMixedExperiment {

    public Exp_thoracic_surgery(Set<MissingMixedMethod> methods) {
        super(methods);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        /* Run experiment */
        Exp_thoracic_surgery exp = new Exp_thoracic_surgery(methods);
        for(double missingPercentage = 0.3; missingPercentage < 0.6; missingPercentage += 0.1) {
    ...
    public void runExperiment(double missingPercentage,
        ...
        System.out.println("------------------------------------------------------------------");
        System.out.println("------------------------------------------------------------------");
        System.out.println("------------------------ THORACIC_SURGERY ------------------------");
        System.out.println("------------------------------------------------------------------");
        System.out.println("------------------------------------------------------------------");

        String dataName = "thoracic_surgery";
