...
public class Exp_user_knowledge extends MissingMixedExperiment {

    public Exp_user_knowledge(Set<MissingMixedMethod> methods) {
        super(methods);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        /* Run experiment */
        Exp_user_knowledge exp = new Exp_user_knowledge(methods);
