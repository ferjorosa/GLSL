...
public class Exp_housing_prices extends MissingMixedExperiment {

    public Exp_housing_prices(Set<MissingMixedMethod> methods) {
        super(methods);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        /* Run experiment */
        Exp_housing_prices exp = new Exp_housing_prices(methods);
