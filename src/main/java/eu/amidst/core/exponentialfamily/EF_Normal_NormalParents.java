...
public class EF_Normal_NormalParents extends EF_ConditionalDistribution  {
     ...
     */
    /*
        MyNote: He intentado hacerlo pero me he encontrado un monton de cosas que no entiendo bien, principalmente
        con los momentos de las distribuciones, sobretodo de la Gaussian, parece que la Gamma lo he hecho bien, pero
        la de la Gaussian no entiendo la transformacion a normal parameters que hace (no coincide con lo establecido en
        wikipedia), quizas tendria que hacer como con la normal_gamma y darle un repaso entero yo mismo...
     */
    @Override
    public List<EF_ConditionalDistribution> toExtendedLearningDistribution(ParameterVariables variables, String nameSuffix, double[] priorsParameters){
        ...
        return this.toExtendedLearningDistribution(variables, nameSuffix);
    }
