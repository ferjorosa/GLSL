...
public class ConstrainedIncrementalLearner implements LatentDiscreteMethod, LatentContinuousMethod, LatentMixedMethod, BayesianMethod {
    ...
    public ConstrainedIncrementalLearner(long seed,
